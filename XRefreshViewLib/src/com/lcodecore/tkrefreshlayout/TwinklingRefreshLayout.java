...
public class TwinklingRefreshLayout extends RelativeLayout implements PullListener {
	 ...
	 * 拦截事件
	 *
	 * @return return true时,ViewGroup的事件有效,执行onTouchEvent事件 return
	 *         false时,事件向下传递,onTouchEvent无效
	 */
	@Override
	...
	/**
	 * TODO 适配可以随界面滚动的Header public void addNormalExHeader(View view) { if (view
	 * != null && mExtraHeadLayout != null) { mExtraHeadLayout.addView(view);
	 * cp.onAddExHead(); cp.setExHeadNormal(); } }
	 **/
	 ...
	 * 设置OverScroll时自动加载更多
	 *
	 * @param ifAutoLoadMore
	 *            为true表示底部越界时主动进入加载跟多模式，否则直接回弹
	 */
	...
	public class CoContext {
		...
		// private boolean enableOverScrollTop = false, enableOverScrollBottom =
		// false;
