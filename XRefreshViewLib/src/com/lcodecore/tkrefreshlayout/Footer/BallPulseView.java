...
public class BallPulseView extends View implements IBottomView {
	...
	private Map<ValueAnimator, ValueAnimator.AnimatorUpdateListener> mUpdateListeners = new HashMap<ValueAnimator, AnimatorUpdateListener>();
	...
	private int animatingColor = 0xfffcd953;
	...
	public void startAnim() {
		...
		for (int i = 0; i < mAnimators.size(); i++) {
			...
			// when the animator restart , add the updateListener again because
			// they was removed by animator stop .
